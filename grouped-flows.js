...
module.exports = function(RED) {
    ...
    RED.httpAdmin.get("/nr-grouped-flows/groups", RED.auth.needsPermission(""), function(req, res) {
    ...
    RED.httpAdmin.post("/nr-grouped-flows/groups", RED.auth.needsPermission(""), function(req, res) {
        const data = req.body;
